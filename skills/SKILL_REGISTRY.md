...
> 76 skills across 14 domains. Domain-specific registry parallel to `agents/AGENT_REGISTRY.md`. Source-of-truth for skill ownership, version, and status; `skill-rules.json` remains the source-of-truth for activation triggers (keywords, agents, intents).
...
domain: <top-level-dir>              # one of 14: business, energy-intelligence, health, integration,
                                     # intelligence, machine, memory, music-is, orchestration,
                                     # people-intelligence, relational, safety, sound-intelligence, vision
