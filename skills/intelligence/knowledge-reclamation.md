...
4. **Non-technical users first.** Provide folder-tree templates, drag-and-drop instructions, and platform-specific recipes (Google Drive, Notion, Dropbox, local file manager). Never require CLI, scripts, or terminal access. Ana-grade test: would this work in Claude Desktop + Cowork? If not, rewrite.
