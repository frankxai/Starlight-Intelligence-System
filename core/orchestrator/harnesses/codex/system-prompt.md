...
5. **HR-shape leakage.** Does `verticals/_template/` carry assumptions that fit HR Intelligence but break for Sound IS, Code IS, or other domains? (v7.5 board REVISE Item 7.)
