...
const MODULES: IntelligenceModuleDefinition[] = [
  ...
  {
    id: 'self-is',
    name: 'Self Intelligence System',
    kind: 'universal-is',
    description: 'Founder performance intelligence — identity, rituals, energy, beliefs, habits, cognitive operating system, and sovereign personal optimization protocols.',
    defaultEnabled: true,
    dashboardViews: ['vaults', 'brain', 'decisions'],
    permissions: ['self:read', 'self:write-local'],
  },
  {
    id: 'family-is',
    name: 'Family Intelligence System',
    kind: 'universal-is',
    description: 'Family office intelligence — relationships, legacies, governance, shared memory, and sovereign family decision protocols. All data sovereign-private; no external transmission.',
    defaultEnabled: false,
    dashboardViews: ['vaults'],
    permissions: ['family:private-records', 'vault:private'],
  },
  {
    id: 'creator-is',
    name: 'Creator Intelligence System',
    kind: 'universal-is',
    description: 'Media and influence intelligence — content pipeline, audience intelligence, distribution, brand partnerships, superfan systems, and creative output velocity.',
    defaultEnabled: true,
    dashboardViews: ['mission-control', 'packs', 'tooling'],
    permissions: ['creator:read', 'creator:write-local'],
  },
  {
    id: 'brand-is',
    name: 'Brand Intelligence System',
    kind: 'universal-is',
    description: 'Reputation and positioning intelligence — FrankX / Arcanea / Starlight brand coherence, voice anti-slop enforcement, visual system, SEO, and public narrative.',
    defaultEnabled: true,
    dashboardViews: ['mission-control', 'decisions'],
    permissions: ['brand:read', 'brand:write-local'],
  },
  {
    id: 'orchestrator-is',
    name: 'Starlight Orchestrator',
    kind: 'universal-is',
    description: 'Private intelligence office — the master orchestration layer that routes, coordinates, and synthesizes all 9 other Intelligence Systems. isMasterOrchestrator.',
    defaultEnabled: true,
    dashboardViews: ['mission-control', 'tooling', 'decisions', 'vaults', 'brain', 'packs'],
    permissions: ['orchestrator:read', 'orchestrator:write-local', 'orchestrator:cross-is'],
  },
  {
    id: 'hermes-swarm',
    name: 'Hermes Swarm Core',
    kind: 'core',
    description: 'Nous Research Hermes-3 agent fleet backing all 10 IS domains. Manages specialist + executor profiles per IS, swarm conductor, vault-writer, and sentinel-monitor.',
    defaultEnabled: true,
    dashboardViews: ['mission-control', 'tooling'],
    permissions: ['hermes:localhost-only', 'hermes:openrouter'],
  },
  {
    id: 'people-is',
