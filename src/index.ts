...
export {
  SIS_VAULT_NAMES,
  SIS_CONFIDENCE_LEVELS,
  SIS_ENTRY_TYPES,
  ensureCanonicalSisLayout,
  resolveCanonicalSisHome,
  parseTagsValue,
  parseMetadataValue,
  buildTypedMetadata,
  validateSisWriteInput,
  normalizeSisReadEntry,
  validateCanonicalSisEntry,
  validateCanonicalSisVaultRows,
  safeRead,
  parseJsonl,
  getCanonicalSisVaultPath,
  buildCanonicalSisEntry,
  appendJsonl,
...
export type {
  ...
  SisConfidenceLevel,
  SisEntryTypeName,
  SisEntryTypeDefinition,
  SisWriteInput,
  SisNormalizedWriteInput,
  SisValidationResult,
  CanonicalSisEntry,
  CanonicalSisValidationResult,
  CanonicalSisVaultStats,
} from "./canonical-sis.js";
export type {
  CanonicalSisMcpToolDefinition,
  CanonicalSisMcpResourceDefinition,
  CanonicalSisResourcePayload,
} from "./canonical-sis-mcp.js";
export type {
  ContextOptions,
  ContextLayer,
