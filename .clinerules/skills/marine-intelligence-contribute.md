# Skill: marine-intelligence-contribute
> Use when contributing to or reasoning over the Ocean / Marine Intelligence vertical — species pages, field missions, marine research, the Blue Life Commons. Orients to the external triad (commons + IS-engine + OS) and routes to the right authoring skill.
