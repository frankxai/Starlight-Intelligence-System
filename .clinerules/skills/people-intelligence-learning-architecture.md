# Skill: people-intelligence/learning-architecture
> Design adult-learning programs that actually transfer to the job. Outcome-back curriculum, spaced retrieval, encoding-specificity, cognitive-load discipline, Kirkpatrick L3+L4 measurement, train-the-trainer protocols. Refuses one-off-workshop theater and L1-only smile-sheet evaluation.
