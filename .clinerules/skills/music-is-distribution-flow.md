# Skill: music-is/distribution-flow
> DistroKid + Bandcamp + frankx.ai/music + Spotify Canvas distribution. Triggers on /music-release distro phase, /music-sync-pitch, distribution requests. Senior tier (Sonnet 4.6) → external rails.
