# Skill: integration/domain-stack-architecture
> Reason about domain-specific intelligence sub-stack architecture — sub-system decomposition, command sequencing, cross-domain synthesis identification, productization paths. Powers /spawn-domain-stack and assists humans designing their own domain verticals.
