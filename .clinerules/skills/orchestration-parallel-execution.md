...
> Use when running multiple independent tasks concurrently across agents, tools, or systems — ensures thread safety, proper result collection, and efficient resource usage. Default skill for Starlight Orchestrator.
