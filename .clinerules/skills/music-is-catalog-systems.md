# Skill: music-is/catalog-systems
> Catalog hygiene, master CSV operations, label-board portfolio scorecard. Triggers on /music-label-board, catalog CRUD, weekly hygiene rituals, status checks. Mechanical tier (Haiku 4.5).
