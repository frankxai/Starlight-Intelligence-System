...
> Use when sizing solar PV, storage, thermal, or combined energy systems — every numerical claim flows through `@starlight/calculators`, never LLM math. Sub-system 1 of 6 in the Energy Intelligence reference vertical. v0.1.0-scaffold awaiting v8.x full protocol.
