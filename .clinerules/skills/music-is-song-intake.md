# Skill: music-is/song-intake
> Capture a Suno URL into catalog/draft, queue assets, attach metadata. Triggers on /music-song, "add this song to catalog", "intake [suno-url]", new song notification. Mechanical tier (Haiku 4.5).
