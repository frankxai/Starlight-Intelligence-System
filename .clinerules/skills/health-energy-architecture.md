# Skill: health/energy-architecture
> Map energy availability across five dimensions, detect leaks, and architect energy around creative peaks. Powers /energy-audit and informs every regimen designed via /design-regimen.
