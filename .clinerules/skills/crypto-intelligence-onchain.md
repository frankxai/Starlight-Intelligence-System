...
> House-tier skill for Crypto Intelligence / House of On-Chain. Auto-activates on /crypto-onchain-* commands. Enforces chain-data source citation, mechanism-context grounding, named output artifact discipline, R5 non-advisory clause inline. House 1 of 6 (v0.1 proof-of-pattern; remaining 5 Houses gated on v0.1-proof-pass per Board 2026-05-17 R4).
