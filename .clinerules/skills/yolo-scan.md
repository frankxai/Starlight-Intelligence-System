# Skill: yolo-scan
> Council-shared scan skill — each council member invokes this with their domain lens to scan active repos and return structured move-proposal packets. Used inside /yolo session opens by all 7 agents in parallel.
