# Skill: vision/fundamentals-excavation
> Excavate the founder's actual vision (not the pitch) across 30/10/3-year + annual + quarterly horizons. Each horizon produces a named artifact. Ladders are tested for drift. Powers /define-vision and the Visionary agent.
