...
> Use when modeling LCOE, payback, financing structure, or total-cost-of-ownership for energy systems — every number flows through `@starlight/calculators`, with valid_as_of timestamp + assumption list. Sub-system 2 of 6 in the Energy Intelligence reference vertical. v0.1.0-scaffold.
