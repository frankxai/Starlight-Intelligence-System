# Skill: orchestration/sage-autonomous-execution
> Auto-activates SAGE autonomous goal execution loops for long-running /goal tasks, managing checkpointing, git rollback, context compression, and Sentinel audits.
