...
> Use when designing post-install monitoring, performance verification, predictive maintenance, or warranty-claim lifecycle — the "is the system actually doing what we promised?" sub-system. Surfaces underperformance honestly. Sub-system 4 of 6 in the Energy Intelligence reference vertical. v0.1.0-scaffold.
