...
> Use when saving context for future sessions or session handoffs — captures decisions, progress, pending work, and relevant state into persistent storage that can be restored. Default skill for Starlight Orchestrator and Starlight Sage.
