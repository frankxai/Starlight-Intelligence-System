# Skill: memory/capture-discipline
> Use when designing daily capture, note-taking, or personal-knowledge operations — defines the discipline of when, what, and where to capture. Tool-agnostic; the practice survives tool changes. Default skill for Starlight Second Brain.
