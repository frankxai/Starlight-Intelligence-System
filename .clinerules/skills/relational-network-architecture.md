# Skill: relational/network-architecture
> Map a sovereign person's current network, audit compounding vs draining flows, identify gaps, design an investment plan, and produce a weekly/monthly/quarterly cadence. Powers /map-relationships and the Relational agent.
