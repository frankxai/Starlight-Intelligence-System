...
> Use when multiple Starlight agents need to collaborate on a related task — handles agent selection, task decomposition, dependency management, and result aggregation across the council. Default skill for Starlight Orchestrator.
