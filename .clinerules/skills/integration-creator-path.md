# Skill: integration/creator-path
> Walk non-technical creators from idea to stamped artifact without opening a terminal. Uses /badge route for attestation. Powers Envoy agent.
