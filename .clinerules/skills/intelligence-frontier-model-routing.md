# Skill: intelligence/frontier-model-routing
> Dynamic routing across frontier LLMs and reasoning models (Claude 3.7 Thinking, o1/o3-mini, Gemini 2.0/2.5 Pro/Flash, DeepSeek-R1, Grok 3), matching cognitive depth, token budgets, and tool capabilities to task requirements.
