# Skill: music-is/suno-prompt
> Grounded Suno prompt synthesis from local knowledge corpus + persona canon + label canon. Triggers on /music-suno-prompt, "suno prompt for", "generate prompt for [persona]", "what should I prompt for [intent]". Senior tier (Sonnet 4.6).
