...
> Use when designing the hiring instrument — ICP, structured interview architecture, calibration, debrief, onboarding — using meta-analytically validated predictive components. Refuses unstructured interviews and personality-as-primary. Sub-system 1 of 6 in the People Intelligence reference vertical.
