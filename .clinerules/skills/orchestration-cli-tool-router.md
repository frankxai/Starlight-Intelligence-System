# Skill: orchestration/cli-tool-router
> Route operator tasks across local AI CLIs and native generation tools. Fires for /si, /so, CLI routing, dispatch, Antigravity, Grok, Claude, Codex, Gemini, OpenCode, Cursor, image generation, and tool-choice requests.
