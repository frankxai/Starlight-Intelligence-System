# Skill: music-is/release-gate
> A&R green-light gate. Non-waivable. Triggers on /music-release. Apex tier (Opus 4.7) for the gate decision; orchestrates Sonnet downstream for distribution + amplification + royalty graph if pass.
