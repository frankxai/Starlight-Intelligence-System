# Skill: music-is/persona-canon
> Spawn and defend per-persona canon. Triggers on /music-persona, "spawn persona", "define artist", "lock canon for", canon-defense work, voice-lock checks. Apex tier (Opus 4.7). One persona-keeper agent per active persona.
