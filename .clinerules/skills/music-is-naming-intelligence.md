# Skill: music-is/naming-intelligence
> Persona, label, track, and product naming for Music IS. Triggers on /music-name, "name this persona", "name candidates for", "is this name available", naming-decision questions. Senior tier (Sonnet 4.6) for synthesis; Apex (Opus) for canonical-name-lock decisions.
