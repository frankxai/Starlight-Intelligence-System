# Skill: orchestration/hermes-swarm
> Use when dispatching the Hermes agent swarm for any multi-IS or complex task — routes to IS-specialist Hermes profiles, coordinates parallel execution, aggregates synthesis, and writes results to vaults. Default skill for Starlight Hermes, Starlight Orchestrator, and Hermes Claw.
