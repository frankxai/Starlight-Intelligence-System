...
> Use when storing, retrieving, or managing persistent memory across the Starlight Vaults — handles reading, writing, querying, and organizing entries across all vaults. Default skill for Starlight Prime and Starlight Sage.
