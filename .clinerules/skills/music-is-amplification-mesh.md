# Skill: music-is/amplification-mesh
> Voice-locked, frequency-capped amplification across X/IG/TikTok/YT/Spotify per persona. Triggers on /music-amplify, post-release amplification scheduling, OpenClaws orchestration. Senior tier (Sonnet 4.6).
