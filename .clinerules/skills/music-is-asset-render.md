# Skill: music-is/asset-render
> Orchestrate cover (nano banana 2), motion (Seedance 2), cinematic (Higgsfield), shorts/Canvas (Remotion) for a draft song. Triggers on asset render requests, /music-canvas, new song-intake events. Senior tier (Sonnet 4.6) → external engines.
