# Skill: yolo-conductor
> Drives the /yolo Hive session loop — open, parallel council scan, Prime synthesis, present moves, execute selected move with substrate gate + subagent QA + verification, persist, loop. Activates on /yolo command invocation.
