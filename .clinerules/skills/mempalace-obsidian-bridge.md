# Skill: mempalace-obsidian-bridge
> Bridge MemPalace recalls into curated Obsidian notes. Activates when the user asks to recall, curate, or persist a thought into the vault. Closes the gap between automated capture (MemPalace) and human-readable knowledge (Obsidian).
