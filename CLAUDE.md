...
- **94 Skills** — Auto-activate via `skills/skill-rules.json` across 18 domains (**academy**, intelligence, orchestration, memory, integration, **foundry**, business, vision, health, relational, **people-intelligence**, sound-intelligence, music-is, energy, machine, **crypto-intelligence**, **safety**, **marine-intelligence**). Academy adds open capability and execution graphs, missions, evidence evaluation, learner-controlled Passport projections, and bounded teaching-agent composition. Foundry adds skills-first capability compilation, agent necessity gates, bounded system packaging, and executable taste evaluation. Existing orchestration includes `/yolo`, `/si` + `/so`, SAGE, and Hermes Swarm.
