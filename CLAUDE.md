...
- **54 Agents** — 7 legacy council (leadership + specialist + foundation tiers, top-level `agents/*.md`) + 7 Council Archetype seats (v0.1 Friday demo, at `agents/council/*.md` — Elder Father, Elder Mother, Sage, Builder-Elder, Shadow Witness, Divine Neutral Witness, Future Self at 90) + 3 front-door + 1 excavation + 5 universal-IS + 6 People Intelligence + 6 Sound Intelligence + 7 Music IS + 7 Energy Intelligence (v0.1 placeholders, 2026-05-28) + 5 SIS Extractors for `/sis-forge` Phase 1. Full registry: `agents/AGENT_REGISTRY.md`.
