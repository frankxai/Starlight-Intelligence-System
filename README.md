...
flowchart TB
  ...
  Adapters["Claude Code · Cursor · Cline · Codex · Gemini · Antigravity (agent swarm) · OpenCode"]
...
| Platform adapters | Same substrate across Claude Code, Cursor, Cline, Codex, Gemini CLI, Antigravity (multi-agent native swarm + harness), OpenCode |
