...
- **SIS** — the reference implementation: 146 specialized agents, 87 auto-activating skills, 6 semantic vaults, a production MCP server, and the repeatable **Estate Factory** for running full sovereign agent armies.
...
| **SIS (Reference)** | Complete working system: 146 agents, 87 skills, 6 vaults, MCP server, Estate Factory. | Running it as your daily multi-agent brain |
