...
# Get GitHub URL portable (use PROJECT_ROOT to relativize for common repos)
GITHUB_URL=""
REL=""
if [[ "$FILE_PATH" == *"/FrankX/"* ]]; then
  REL="${FILE_PATH#*/FrankX/}"
  GITHUB_URL="https://github.com/frankxai/FrankX/blob/main/$REL"
elif [[ "$FILE_PATH" == *"/arcanea/"* ]]; then
  REL="${FILE_PATH#*/arcanea/}"
  GITHUB_URL="https://github.com/frankxai/arcanea/blob/main/$REL"
elif [[ "$FILE_PATH" == *"/agentic-creator-os/"* ]]; then
  REL="${FILE_PATH#*/agentic-creator-os/}"
  GITHUB_URL="https://github.com/frankxai/agentic-creator-os/blob/main/$REL"
else
  # generic: if under project root, make relative
