...
**Status:** decision record and plan, 2026-09-21 (night). Operational tier. Substrate untouched; two dimensions are blocked on Board and carry their Board proposals in section 7.
...
6. **It kept the Queen first and the rules second.** The routing table has never had a class with `autoApply` true; the Queen has routed nothing on evidence. v4 inverts the order: the constitution gates every envelope from the next one; the Queen routes inside it.
