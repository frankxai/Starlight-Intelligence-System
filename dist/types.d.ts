 ...
 */
export type AgentExecutor = (agent: string, input: string, context: Record<string, unknown>) => Promise<string>;
/** The six orchestration patterns available in the engine. */
export type OrchestrationPattern = "direct" | "sequential" | "parallel" | "iterative" | "cascade" | "broadcast";
/** Synthesis strategy for combining multi-agent outputs. */
export type SynthesisStrategy = "weighted-consensus" | "sequential-refinement" | "conflict-resolution";
/**
