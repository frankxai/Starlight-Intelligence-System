...
export const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { href: "/agents", label: "Agents", desc: "The live 144-agent registry" },
      { href: "/skills", label: "Skills", desc: "The live auto-activating skill set" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/metrics", label: "Metrics", desc: "The living metrics ledger" },
