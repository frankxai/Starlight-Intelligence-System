...
export const metadata: Metadata = {
  ...
  description:
    "A persistent context and memory architecture for AI agents. 10 intelligence systems, 48 agents, 100+ commands, 3 reference Domain Sub-Stack verticals. Built on the Starlight Intelligence Protocol. Local-first. Forkable. Free.",
  alternates: { canonical: "/" },
  openGraph: {
    title:
      "Starlight Intelligence — Persistent context for AI agents · Built on SIP",
    description:
      "10 intelligence systems, 48 agents, 100+ commands, 3 reference verticals. Built on SIP. Local-first. Forkable. Free.",
